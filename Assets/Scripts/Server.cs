        ...
        if (initSDKOutcome.Success)
        {
            ProcessParameters processParameters = new ProcessParameters(
               ...
               new LogParameters(new List<string>()
               {
                    ...
                    Startup.IsArgFlagPresent("-isProd") ? "/local/game/logs/server.log" : "~/workspace/logs/social_server/server.log"
               }
            ));
            ...
            if (processReadyOutcome.Success)
            {
                ...
                if (_server != null)
                {
                    Debug.Log("NetworkServer is good.");
                    _server.StartTCPServer(_tcpServerPort);
                }
                else
                {
                    Debug.Log("NetworkServer is null.");
                }
            }
            else
            {
